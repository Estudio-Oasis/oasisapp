    ...
    <div className="min-h-screen font-body bg-[hsl(var(--paper))]">
      ...
      <section className="pt-24 md:pt-28 pb-14 md:pb-20">
        <div className="max-w-[1700px] mx-auto px-4 md:px-6">
          ...
          <h1 className="mt-5 font-ultra text-[clamp(40px,10vw,190px)] md:text-[min(8.6vw,14vh)] leading-[0.92] text-[hsl(var(--ink))]">
            Dinos qué te pasa.
            <br />
      ...
      <section className="border-t-2 border-[hsl(var(--ink))] py-10 md:py-16">
        <div className="max-w-[1700px] mx-auto px-4 md:px-6">
          ...
          >
            <div>
              <span className="font-label text-[10px] tracking-[0.28em] uppercase" style={{ color: active.color }}>
                Diagnóstico honesto
              </span>
              <p className="mt-3 font-condensed text-[clamp(21px,2.8vw,38px)] leading-[1.12] text-[hsl(var(--ink))]">
                {active.diagnosis}
              </p>
              <div className="mt-6 flex flex-wrap gap-2">
                {active.stages.map((s) => (
                  <span
                    key={s}
                    className="font-label text-[10px] tracking-[0.18em] uppercase px-3 py-2 border-2"
            ...
            <div>
              <span className="font-label text-[10px] tracking-[0.28em] uppercase text-[hsl(var(--ink)/0.40)]">
                Cómo lo trabajamos
              </span>
              <ol className="mt-4 border-t border-[hsl(var(--ink)/0.15)]">
                {active.plan.map((p, i) => (
                  <li key={p} className="py-4 border-b border-[hsl(var(--ink)/0.15)] flex gap-4">
                    <span
              ...
              <Link
                to="/#brief"
                className="mt-7 inline-flex items-center gap-2 h-12 px-6 bg-[hsl(var(--ink))] text-[hsl(var(--paper))] hover:bg-[#C5221F] transition-colors font-label text-[10px] tracking-[0.2em] uppercase"
              >
      ...
      <section className="border-t-2 border-[hsl(var(--ink))] py-14 md:py-20">
        <div className="max-w-[1700px] mx-auto px-4 md:px-6">
          <h2 className="font-ultra text-[clamp(30px,6.4vw,96px)] md:text-[min(5vw,8vh)] leading-[0.95] text-[hsl(var(--ink))]">
            El sistema completo <span className="text-[hsl(var(--ink)/0.30)]">en 5 etapas.</span>
          </h2>
      ...
      {/* Cómo cotizamos */}
      <section className="bg-[hsl(var(--ink))] py-16 md:py-24">
        <div className="max-w-[1700px] mx-auto px-4 md:px-6">
          <p className="font-label text-[10px] md:text-[11px] tracking-[0.35em] uppercase text-[hsl(var(--paper)/0.40)]">
            Cómo cotizamos
          </p>
          <h2 className="mt-5 font-ultra text-[clamp(32px,7vw,110px)] md:text-[min(5.6vw,9vh)] leading-[0.95] text-[hsl(var(--paper))]">
