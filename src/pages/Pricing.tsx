...
import { Check, ArrowLeft, Zap, Users, Shield } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="text-center pt-12 pb-8 px-6">
        ...
        <p className="text-foreground-secondary text-lg max-w-xl mx-auto mb-8">
          Empieza gratis. Escala cuando tu equipo crezca.
        </p>
        ...
        <div className="flex items-center justify-center gap-3 mb-2">
          ...
          {annual && (
            <span className="text-xs font-semibold text-success bg-success-light px-2 py-0.5 rounded-full">
              2 meses gratis
            </span>
          )}
        </div>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-20 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="border border-border rounded-xl p-6 flex flex-col">
          ...
          <Button
            variant="secondary"
            className="w-full"
            onClick={() => navigate(user ? "/bitacora" : "/signup")}
          >
        ...
        <div className="border-2 border-foreground rounded-xl p-6 flex flex-col relative">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2">
            <span className="text-[10px] font-bold uppercase tracking-wider bg-foreground text-background px-3 py-1 rounded-full">
              Más popular
            </span>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-4xl font-bold text-foreground">
                ${annual ? Math.round(proAnnual / 12) : proMonthly}
              </span>
              <span className="text-foreground-muted text-sm">/mes</span>
            </div>
            {annual && (
              <p className="text-xs text-foreground-muted mt-1">
                ${proAnnual}/año — ahorras ${proMonthly * 2}
              </p>
            )}
          </div>
          ...
          <Button
            ...
            onClick={() => handleCheckout(STRIPE_PLANS.team_6.price_id, "pro")}
          >
        ...
        <div className="border border-border rounded-xl p-6 flex flex-col">
          <div className="mb-6">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-4xl font-bold text-foreground">
                ${annual ? Math.round(agencyAnnual / 12) : agencyMonthly}
              </span>
              <span className="text-foreground-muted text-sm">/mes</span>
            </div>
            {annual && (
              <p className="text-xs text-foreground-muted mt-1">
                ${agencyAnnual}/año — ahorras ${agencyMonthly * 2}
              </p>
            )}
          </div>
          ...
          <Button
            ...
            onClick={() => handleCheckout(STRIPE_PLANS.team_10.price_id, "agency")}
          >
