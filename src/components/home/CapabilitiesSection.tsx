  ...
  return (
    <section className="bg-[#FCFCFA] border-t-2 border-[#111110] pt-10 md:pt-16 pb-20 md:pb-28">
      <div className="max-w-[1700px] mx-auto px-4 md:px-6">
        ...
        <h2 className="mt-5 font-ultra text-[clamp(34px,7.4vw,120px)] md:text-[min(6vw,10vh)] leading-[0.95] text-[#111110]">
          Más de 30 expertos <span className="text-[#111110]/30">en una sola mesa.</span>
        </h2>
        ...
        <div className="mt-14 md:mt-20">
          <p className="font-ultra text-[clamp(34px,7.6vw,130px)] md:text-[min(6.6vw,11vh)] leading-[0.92] text-[#111110]">
            We&apos;re the ultimate{" "}
            <button
              type="button"
          ...
          {openFixer && (
            <div className="mt-6 border-t-2 border-b-2 border-[#1A73E8] py-6 md:py-10 animate-rise-in grid md:grid-cols-[0.9fr_1.4fr] gap-6 md:gap-12">
              <div>
                <span className="font-mono-label text-[11px] tracking-[0.28em] uppercase text-[#1A73E8]">
                  ¿Qué es un fixer?
                </span>
              ...
              <div className="space-y-4">
                ...
                <p className="font-body text-[15px] md:text-[18px] leading-relaxed text-[#111110]/60 max-w-[62ch]">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 font-mono-label text-[10px] tracking-[0.2em] uppercase text-[#111110]/50 hover:text-[#111110] transition-colors"
                >
