...
export function BrutalistHero() {
  return (
    <section className="bg-[hsl(var(--paper))] pt-20 md:pt-16 pb-16 md:pb-20">
      {/* Headline */}
      <div className="max-w-[1700px] mx-auto px-4 md:px-6">

        <h1 className="font-ultra text-[hsl(var(--ink))] leading-[0.9] text-[clamp(46px,11.5vw,220px)] md:text-[min(9.6vw,15vh)]">
        ...
        <p className="mt-6 md:mt-8 font-condensed text-[clamp(22px,4.6vw,56px)] md:text-[min(3vw,5vh)] leading-[1.05] text-[hsl(var(--ink)/0.35)] flex items-baseline gap-[0.2em] flex-wrap">
          <span>Para</span>
      ...
      <div className="max-w-[1700px] mx-auto px-4 md:px-6 mt-12 md:mt-16 border-t-2 border-[hsl(var(--ink))] pt-8 md:pt-10">
        <h2 className="font-ultra text-[clamp(30px,6.4vw,96px)] md:text-[min(5vw,8vh)] leading-[0.95] text-[hsl(var(--ink))]">
          ...
          <span className="text-[hsl(var(--ink)/0.30)]">en 5 etapas.</span>
        </h2>
